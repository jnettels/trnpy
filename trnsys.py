...
def run_OptionParser(TRNExe, dck_processor):
    ...
    parser.add_argument('dck', help='One or multiple paths to ' +
                        'TRNSYS deck files', type=str, nargs='+')
    ...
    # Get list of deck files (and convert relative paths into absolute paths)
